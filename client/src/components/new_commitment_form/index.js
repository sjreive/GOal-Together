...
export default function NewCommitmentForm(props) {
  ...
  return (
    <section className={classes.newCommitmentSection}>
      <Form
        className={classes.newCommitForm}
      ...
      >
        ...
        {mode === "NAME" && (
          <Name
            clickBack={e => back()}
            clickNext={e => transition("DESCRIPTION")}
            name={name}
        ...
        {mode === "STAKES" && (
          <Stakes
            clickBack={e => back()}
            clickNext={e => transition("DATE")}
            stakes={stakes}
            setStakes={e => setStakes(e.target.value)}
          />
        )}
        {mode === "DATE" && (
          <EndDate
            clickBack={e => back()}
            clickNext={e => transition("MEMBERS")}
            endDate={endDate}
